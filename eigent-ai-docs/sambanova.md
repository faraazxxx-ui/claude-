[Skip to main content](https://docs.eigent.ai/core/models/sambanova#content-area)
...
- [Prerequisites](https://docs.eigent.ai/core/models/sambanova#prerequisites)
- [Configuration Steps](https://docs.eigent.ai/core/models/sambanova#configuration-steps)
- [1\. Access Application Settings](https://docs.eigent.ai/core/models/sambanova#1-access-application-settings)
- [2\. Locate Model Configuration](https://docs.eigent.ai/core/models/sambanova#2-locate-model-configuration)
- [3\. Enter API Details](https://docs.eigent.ai/core/models/sambanova#3-enter-api-details)
- [4\. Set as Default & Verify](https://docs.eigent.ai/core/models/sambanova#4-set-as-default-%26-verify)
