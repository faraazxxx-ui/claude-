[Skip to main content](https://docs.eigent.ai/core/models/ernie#content-area)
...
- [Prerequisites](https://docs.eigent.ai/core/models/ernie#prerequisites)
- [Configuration Steps](https://docs.eigent.ai/core/models/ernie#configuration-steps)
- [1\. Access Application Settings](https://docs.eigent.ai/core/models/ernie#1-access-application-settings)
- [2\. Locate Model Configuration](https://docs.eigent.ai/core/models/ernie#2-locate-model-configuration)
- [3\. Enter API Details](https://docs.eigent.ai/core/models/ernie#3-enter-api-details)
- [4\. Set as Default & Verify](https://docs.eigent.ai/core/models/ernie#4-set-as-default-%26-verify)
